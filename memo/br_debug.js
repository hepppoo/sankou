(function() {
    ...
    var t = function(a) {
      ...
      , Ea = function(a, b, c) {
        ...
        g.test(a) ? I.write("<script" + c + ' src="' + a + '">\x3c/script>') : J("URL uses invalid characters. Dropping request for: %s", a)) : (c = I.createElement("script"),
    ...
    var hd, Ee = /^.*Version\/?(\d+)[^\d].*$/i, ff = function() {
        if (void 0 !== Q.__ga4__)
            return Q.__ga4__;
        if (void 0 === hd) {
    ...
    var Da, Sb, cc, dc, ma = /^https?:\/\/[^/]*cdn\.ampproject\.org\//, sc = [], Uc = function() {
        ...
        e.onload = function() {
            ...
            if (4 == e.readyState) {
                try {
                    200 != e.status && (J("Could not get client id from AMP."),
                    F(61),
                    yd("", "$ERROR", 3E4));
                    var d = JSON.parse(e.responseText);
                    d.optOut ? (J("Could not get client id from AMP. User has opeted out."),
                    F(63),
                    yd("", "$OPT_OUT", 31536E6)) : d.clientId ? (N("Got client id from AMP."),
                    yd(d.clientId, d.securityToken, 31536E6)) : !c && d.alternateUrl ? (N("Got an alternate URL to get client id."),
                    Sb && clearTimeout(Sb),
                    Da = !0,
                    ld(a, b, d.alternateUrl)) : (J("Could not get client id from AMP."),
                    F(64),
                    yd("", "$NOT_FOUND", 36E5))
                } catch (ea) {
    ...
    var gf = function() {
                ...
                if (d)
                    try {
                        ...
                        if (1 > a.length)
                            ...
                            var b = a.charAt(1);
                            if ("d" == b)
                                hf("https://stats.g.doubleclick.net/j/collect", d.Y, d, c);
                            else if ("g" == b) {
      ...
      , fc = function(a, b, c) {
        ...
        if (!(1 <= 100 * Math.random() || K("?"))) {
            var d = ["t=error", "_e=" + a, "_v=j67d", "sr=1"];
            b && d.push("_f=" + b);
    ...
    ;var Ie = function() {
      ...
      , ye = function(a) {
        ...
        if (0 == b.Z)
            return 0;
        void 0 === c && (c = be());
        return 0 == c % b.Z ? Math.floor(c / b.Z) % b.ia + 1 : 0
    };
    function Qc() {
        var a, b;
            ...
            if (a.get(We)) {
                ...
                if (c) {
                    ...
                    var e = a.get(Ge)
                      ...
                      , l = Xc(V(a, S))
                      , k = V(a, U);
                    f && "aw.ds" != f ? b && (b.xa = !0) : (c = ["1", e, Ae(c)].join("."),
                    0 < d && (b && (b.wa = !0),
                    pe("_gac_" + Ae(k), c, ea, l, k, d)));
                    Ye(b)
                }
            } else
                F(75);
    ...
    var Fe = function(a, b, c) {
      ...
      , Ke = function(a, b) {
        b.get(Zd) && (N("Setting throttling cookie: %s", a.aa),
      ...
      , lf = function(a, b, c) {
        ...
        f += "z=" + ae();
        0 == c ? (f = a.ca + f,
        od(d, f)) : 1 == c ? f = "t=dc&aip=1&_r=3&" + f : 2 == c && (f = "t=sr&aip=1&_r=4&slf_rd=1&" + f);
        return f
    }
      , ca = function(a, b) {
        null === a.ua && (a.ua = 1 === ye(b),
        a.ua && F(33));
        return a.ua
    }
      , Pe = /^gtm\d+$/;
    ...
    var x = function(a, b, c) {
      ...
      , z = function(a, b, c, d, e) {
        if (!t(Re.get(b)) && !Te.get(b)) {
            ...
            c = b + ".js") : F(43);
            c ? (c && 0 <= c.indexOf("/") || (c = ($b || "https:" == I.location.protocol ? "https:" : "http:") + "//www.google-analytics.com/plugins/ua/" + c),
            d = Ue(c),
            a = d.protocol,
